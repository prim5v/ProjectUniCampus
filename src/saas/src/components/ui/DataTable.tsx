...
export interface Column<T> {
  ...
  /**
   * Render the cell.
   * Also used as the value on mobile cards.
   */
  render: (row: T) => React.ReactNode;

  /**
   * Hidden on the mobile card view
   * (e.g. redundant/decorative).
   */
  hideOnCard?: boolean;
...
interface DataTableProps<T> {
  ...
  /**
   * Must return a unique value for every row.
   */
  ...
  /**
   * Title shown as the primary label
   * on the mobile card.
   */
